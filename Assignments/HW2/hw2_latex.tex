...
\begin{enumerate}
    \item S: Set of all integers that divisible by 4 or divisible by 3 but not both.
    \item T: Set that contains integers that greater than $5$ or real numbers that are greater than 0.
    \item M: Set of all months that starts with letter `B'. 
    \item V: set of all vowels in English alphabet.
    \item D: set of integers up to 20 and divisible by 3
\end{enumerate}
